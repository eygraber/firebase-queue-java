...
public class QueueTaskTest {
  ...
  public void setUp() throws Exception {
    ...
    when(UuidUtils.randomUUID()).thenReturn("uuid");
  ...
  public void cancel_beforeRun_calledTwice_writesALog() {
    ...
    verify(logger).log(Log.Level.INFO, "Not cancelling task (" + taskRef.getKey() + ") on " + QueueTask.PRE_RUN_ID + " because it was already cancelled");
  }
  ...
  public void cancel_afterSuccessfulRun_writesALog() {
    ...
    verify(logger).log(Log.Level.INFO, "Not cancelling task (" + taskRef.getKey() + ") on " + TASK_ID + " because it is already done");
  }
  ...
  public void cancel_beforeRun_writesALog() {
    subject.cancel();
    verify(logger).log(Log.Level.INFO, "Delaying cancelling task (" + taskRef.getKey() + ") on " + QueueTask.PRE_RUN_ID + " because it hasn't started running yet");
  }
  ...
  public void cancel_duringRun_writesALog() {
    ...
    verify(logger).log(Log.Level.INFO, "Cancelling task (" + taskRef.getKey() + ") on " + TASK_ID);
  }
  ...
  public void callingRun_ifCancelled_writesALog() {
    ...
    verify(logger).log(Log.Level.INFO, "Can't run task (" + taskRef.getKey() + ") on " + TASK_ID +  " because it has previously been cancelled");
  }
  ...
  public void callingRun_writesALog() {
    ...
    verify(logger).log(Log.Level.INFO, "Started claiming task (" + taskRef.getKey() + ") on " + TASK_ID);
  }
  ...
  public void callingRun_butCouldNotClaimATask_writesALog() {
    ...
    verify(logger).log(Log.Level.INFO, "Couldn't claim task (" + taskRef.getKey() + ") on " + TASK_ID);
  }
  ...
  public void callingRun_andClaimedATask_writesALog() {
    ...
    verify(logger).log(Log.Level.INFO, "Claimed task (" + taskRef.getKey() + ") on " + TASK_ID);
  }
  ...
  public void callingRun_andClaimedATask_butWasCancelled_writesALog() {
    ...
    verify(logger).log(Log.Level.INFO, "Can't process task (" + taskRef.getKey() + ") on " + TASK_ID + " because it was cancelled while we were claiming it");
  }
  ...
  public void callingRun_andClaimedATask_andWasNotCancelled_writesAStartedLog() {
    ...
    verify(logger).log(Log.Level.INFO, "Started processing task (" + taskRef.getKey() + ") on " + TASK_ID);
  }
  ...
  public void callingRun_andClaimedATask_andWasNotCancelled_writesAFinishedLog() {
    ...
    verify(logger).log(Log.Level.INFO, "Finished processing task (" + taskRef.getKey() + ") on " + TASK_ID);
  }
